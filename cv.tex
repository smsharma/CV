...
\noindent
Primary contributions \emph{(except where indicated with an astrisk\,$^*$, authors are listed in alphabetical order as per the standard in particle physics)}:

\begin{packed_enumerate}[start=23]
...
\end{tabular*}\vspace{1.5mm}
\begin{packed_itemize}
\item \emph{Reviewer}, Phys.Rev. \textbf{D}, Phys.Rev.Lett., Comput.Phys.Commun., JHEP,\hfill 2017 -- Present \\ NeurIPS Machine Learning and the Physical Sciences Workshop
