...
&\faEnvelopeO\hspace{1mm}\href{mailto:smishras@bu.edu}{\texttt{smishras@bu.edu}} 
\phone
...
%\emph{Visiting Researcher}  & {Jun. 2024 -- Aug. 2025}\\
\end{tabular*}
...
%%%%%%%%%%%%
%% Papers (Renamed from "Publications") 
...
%    boxsep=0pt,
%    after skip=2mm,
%    title={\sc{(Acacemic) Research Interests}:~},
%    attach title to upper,
%    fonttitle=\normalfont,
%    coltitle=black]
%{\emph {\small Intersection of AI and physics; neural approaches to simulation-based inference, scalable generative modeling for scientific datasets, probabilistic and differentiable programming, symmetry-preserving data processing; synthesizing data-driven approaches that leverage scale with physics-informed methods that incorporate mechanistic understanding and inductive biases.}}
%\end{tcolorbox}
%
%\vspace{2.0mm}
%
...
\item A. Akhmetzanova, C. Cuesta-Lazaro, \underline{S. Mishra-Sharma}, \emph{Detecting Model Misspecification in Cosmology with Scale-Dependent Normalizing Flows}, \href{https://iopscience.iop.org/article/10.1088/2632-2153/ae107d}{Accepted at Mach.Learn.Sci.Tech.}  \href{https://arxiv.org/abs/2508.05744}{[arXiv:2508.05744]}

\item T. Nguyen, C. Modi, L. Y. Aaron Yung, R. Somerville, \underline{S. Mishra-Sharma}, \emph{Emulating Dark Matter Halo Merger Trees with Graph Generative Models}, \href{https://doi.org/10.1093/mnras/staf1487}{Mon.Not.Roy.Astron.Soc. 543 (2025) 1} \href{https://arxiv.org/abs/2507.10652}{[arXiv:2507.10652]}
...
\item T. Nguyen, J. Read, L. Necib, \underline{S. Mishra-Sharma}, C.A. Faucher-Giguère, A. Wetzel, \emph{Trial by FIRE: Probing the dark matter density profile of dwarf galaxies with GraphNPE}, \href{https://doi.org/10.1093/mnras/staf1118}{Mon.Not.Roy.Astron.Soc. 541 (2025) 3}   \href{https://arxiv.org/abs/2503.03812}{[arXiv:2503.03812]}
...
Invited talks:
\begin{packed_itemize}
  \item FirstPrinciples Talks Series (Remote)  \hfill May. 2026
  \item Lawrence Berkeley Lab AI/ML Seminar \hfill Berkeley, CA, May. 2026
  \item UT Austin Weinberg Institute for Theoretical Physics Seminar \hfill Austin, TX, Mar. 2026
  \item Stanford Astrophysics Colloquium \hfill Stanford, CA, Feb. 2026
  \item Stanford C4DU Research Replication Hackathon (Keynote) \hfill Stanford, CA, Dec. 2025
...
%  \item \emph{Advisory Board}, UKRI Center for Doctoral Training in AI for Decision Making in Complex Systems (Universities of Cambridge and Manchester) \hfill 2024 -- Present
  \item \emph{Journal Reviewer}, \ \scriptsize{Astrophysical Journal, Computer Physics Communications, JCAP, JHEP,  Journal of Open Source Software, MLST, MNRAS, Nature, Nature Communications Physics, Physical Review {D}, Physical Review {Letters}, Reports on Progress in Physics}\normalsize
    \item \emph{Conference Reviewer}, \scriptsize{NeurIPS Workshop Selection (2023--2025), ICML Workshop Selection (2024, 2025), ICLR (2025, 2026), COLM (2025)}\normalsize
...
\noindent
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}}
\large {\sc \Large{\faWpforms~Teaching}}\\
\hline
\end{tabular*}\vspace{3mm}
...
\begin{packed_itemize}
  \item CDS DS 595 AI Methods for Science \href{https://smsharma.io/teaching/ds595-ai4science.html}{[Course Page]} \hfill Spring 2026
\end{packed_itemize}
