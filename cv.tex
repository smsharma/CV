...
\begin{packed_enumerate}[start=45]
...
%- GNN-GravSphere
        ...
        \item T. Nguyen, F. Villaescusa-Navarro, \underline{S. Mishra-Sharma} et al., \emph{How DREAMS are made: Emulating Satellite Galaxy and Subhalo Populations with Diffusion Models and Point Clouds} \href{https://arxiv.org/abs/2409.02980}{[arXiv:2409.02980]}

      \item $^{\dagger}$G. Zhang, $^{\dagger}$T. Helfer, A. Gagliano, \underline{S. Mishra-Sharma}, V.A. Villar, \emph{Maven: A Multimodal Foundation Model for Supernova Science} \href{https://arxiv.org/abs/2408.16829}{[arXiv:2408.16829]}
